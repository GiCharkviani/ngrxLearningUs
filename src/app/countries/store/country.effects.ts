    ...
    return this.actions$.pipe(
      ...
      mergeMap(() =>
        this.countryHttpService.getCountries().pipe(
          ...
          catchError(error => {
            return of(CountryActions.FailedLoadingCountries({error: error.message}))
          })
        )
      )
    );
    ...
    return this.actions$.pipe(
      ...
      exhaustMap(action => {
        return this.countryHttpService.postCountry(action.country).pipe(
          ...
          catchError(error => {
            return of(CountryActions.FailedaddingCountry({error:error.message}))
          })
        )
      })
    )
    ...
    return this.actions$.pipe(
      ...
      exhaustMap(id => {
        return this.countryHttpService.deleteCountry(id.countryId).pipe(
          ...
          catchError(error => {
            return of(CountryActions.FailedDeletingCountry({error: error.message}))
          })
        )
      })
    )
